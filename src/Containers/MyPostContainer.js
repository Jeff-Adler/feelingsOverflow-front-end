        ...
        <>
            ...
            :
                <>
                    <br/><br/>
                    <Switch>
                        <Route path={`/users/${this.props.currentUser.id}/posts`} render={()=> {
                            return (
                                <UserPostContainer getToken={this.props.getToken} currentUser={this.props.currentUser} user={this.props.user}/> 
                            )
                        }}/>
