      ...
      (this.state.isUserLoaded ?
        <div className="App">
          ...
          <Switch>
            ...
            <Route path='/profile' render={() => <UserContainer user={this.state.user} getToken={this.getToken}/>}/>
            <Route path='/' render={() => <PostContainer user={this.state.user} getToken={this.getToken} />}/>
          </Switch>
        </div>
      :
